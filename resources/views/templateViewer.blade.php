...
<div id = "content">
    <table width="100%" class="display nowrap dataTable dtr-inline" id="example" role="grid" aria-describedby="example_info" style="width: 100%;" cellspacing="0">
        <thead>
        <tr role="row">
            <th tabindex="0" class="sorting_asc" aria-controls="example" style="width: 139px;" aria-label="Name: activate to sort column descending" aria-sort="ascending" rowspan="1" colspan="1"> Template Name
            </th>
            <th tabindex="0" class="sorting" aria-controls="example" style="width: 218px;" aria-label="Position: activate to sort column ascending" rowspan="1" colspan="1"> Code Number (Will delete)
            </th>
        ...
        <tfoot>
        <tr>
            <th class="dt-body-right" rowspan="1" colspan="1">Template Name
            </th>
            <th class="dt-body-right" rowspan="1" colspan="1">Will delete. Placeholder.
            </th>
            <th class="dt-body-right" rowspan="1" colspan="1">View
            </th>
            <th class="dt-body-right" rowspan="1" colspan="1">Edit
            </th>
            <th class="dt-body-right" rowspan="1" colspan="1">Delete
            </th>
            <th class="dt-body-right" rowspan="1" colspan="1">Select
            </th>
        </tr>
        </tfoot>
